...
- **[Generate Random Greeting]** - Generate Random Greeting.
...
```bash command
$ git clone https://github.com/benardop/hello-rails-back-end.git
```
...
To run the project, execute the following command for back and front-end applications:
